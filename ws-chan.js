...
(function() {
  var Channel, EventEmitter, PassThrough, SyncTransform, Transform, backoff, websocket, _ref, _ref1,
  ...
  _ref = require('stream'), Transform = _ref.Transform, PassThrough = _ref.PassThrough;

  if (!((Transform != null) && (PassThrough != null))) {
    _ref1 = require('readable-stream'), Transform = _ref1.Transform, PassThrough = _ref1.PassThrough;
  }
